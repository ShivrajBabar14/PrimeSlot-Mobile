...
class EventItinerary extends StatelessWidget {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(event['image'] ?? 'https://picsum.photos/400/200?random=1'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  // Event Title
                  Text(
                    event['title'] ?? 'BizMania 26 — Event Day Itinerary',
                    style: GoogleFonts.montserrat(
                      fontSize: 24,
